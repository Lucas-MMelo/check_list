                        ...
                        <li
                          ...
                          onClick={
                            targetStep.edite
                              ? undefined
                              : () =>
                                  handleToggleState(itemTask.id, targetStep.id)
                          }
                          //
                          onDoubleClick={() =>
                          ...
                          {targetStep.edite ? (
                            ...
                            <>
                              ...
                              <button
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleDeleteStep(itemTask.id, targetStep.id);
